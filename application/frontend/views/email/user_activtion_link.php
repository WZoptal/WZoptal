    ...
    <table width="600" style="background: #fff;margin:0 auto;" cellspacing="0">
      <tr style="">
        <th style="text-align: center;vertical-align: middle;">
          <img src="<?php echo base_url("assets/images/logo_with_bg_img.png"); ?>" style="width:600px;height:110px;">
        </th>
      </tr>
      <tr>
        <td style="text-align: center;padding:40px;">
          <p style="font-size: 48px;color:#C3A563;font-weight: 400;margin-top:0px;border-bottom:1px solid rgba(00,00,00,.30);display:inline-block;padding-bottom:40px;" class="font-family1">Activate your account</p>

          <p style="color:#999999;font-size:16px;font-weight: 400;" class="font-family3">This message has been sent to you by Everlasting Date.</p>
          <p style="color:#999999;font-size:16px;font-weight: 400;" class="font-family3">Please tap the button below to Activate your account.</p>


          <?php if(isset($link)){ ?>
          <div style="text-align:center;margin-top:40px;margin-bottom:10px;">
            <a href="<?php echo $link; ?>" style="color:#FFFFFF;background:#C3A563;border-radius:4px;height:48px;width:210px;display: inline-block;text-decoration: none;font-size: 14px;line-height: 48px;" class="font-family2">Activate account</a>
          </div>
          <?php } ?>
        </td>       
      </tr>
