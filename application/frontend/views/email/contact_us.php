    ...
    <table width="600" style="background: #fff;margin:0 auto;" cellspacing="0">
      ...
      <tr>
        <td style="text-align: center; padding:40px;">
          <p style="font-size: 48px;color:#C3A563;font-weight: 400;margin-top:0px;border-bottom:1px solid rgba(00,00,00,.30);display:inline-block;padding-bottom:40px;" class="font-family1">Contact Us Detail for <?php echo $type; ?></p>

          <p style="color:#999999;font-size:16px;font-weight: 400; text-align: left;" class="font-family3">Name: <?php echo $name; ?></p>
          <p style="color:#999999;font-size:16px;font-weight: 400; text-align: left;" class="font-family3">Email Id: <?php echo $email; ?></p>
          <p style="color:#999999;font-size:16px;font-weight: 400; text-align: left;" class="font-family3">Message: <?php echo $msg; ?></p>
