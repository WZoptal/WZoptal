...
?>
<body class="page-header-fixed"  <?php $pagename=$this->uri->segment(1); if($pagename=="dashboard"){ echo 'onload="initMap()"'; }?>>
	<?php	$controllername=$this->router->class; ?>
<!-- BEGIN HEADER -->

    <?php 
		include('top_area_office.php');   // Are above menu bar is included in this file 
	?>
<!-- END HEADER -->
...
<!-- BEGIN CONTAINER -->
  ...
  <!-- BEGIN SIDEBAR -->
	<?php include('menu_bar_office.php');   // Menu bar is included in this file ?>
  <!-- END SIDEBAR --> 
  <!-- BEGIN CONTENT -->
