<div class="page-sidebar-wrapper">
  <div class="page-sidebar navbar-collapse collapse">
    <ul class="page-sidebar-menu" data-auto-scroll="true" data-slide-speed="200">
      ...
      <li class="<?php if($this->uri->segment(1) == "events"){ ?> active<?php } ?>"> <a href="<?= base_url(); ?>events/manage_events"> <i class="fa fa-object-group" aria-hidden="true"></i> <span class="title"> Posts Management </span> </a> </li>
      <li class="<?php if($this->uri->segment(1) == "office"){ ?> active<?php } ?>"> <a href="<?= base_url(); ?>office"> <i class="fa fa-ra" aria-hidden="true"></i> <span class="title"> Menu Management </span> </a> </li>      
