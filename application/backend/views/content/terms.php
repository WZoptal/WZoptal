...
<div class="row">
    <div class="col-md-12"> 
        ...
        <ul class="page-breadcrumb breadcrumb">
            ...
            <li> <a href="javascript:void(0);">  Content Management  / Terms & Conditions  </a> </li>
        </ul>
    ...
    <div class="col-md-12"> 
        ...
        <div class="tabbable tabbable-custom tabbable-full-width">
            <ul class="nav nav-tabs">
                <li class="active"> <a href="#tab_1_1" data-toggle="tab"> Terms & Conditions </a> </li>
            </ul>
                        ...
                        <div class="col-md-9" style="width:100%">
                            ...
                            <form name="frm" id="frm" action="<?php echo base_url(); ?>content/update_page_to_database" method="post" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    <label class="control-label col-md-4" style="width:11.333333%">Title</label>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-8">
                                        ...
                                        <a href="<?php echo base_url();?>content/terms"  class="btn theme-btn grey pull-left margd">Cancel</a>
                                    </div>
                                </div>
                            </form>
                        </div>
