...
<div class="row">
	<div class="col-md-12"> 
		...
		<h3 class="page-title">Why Equalitix</h3>
		<ul class="page-breadcrumb breadcrumb">
			<li> <i class="fa fa-home"></i> <a href="<?php echo base_url();?>"> Home </a> <i class="fa fa-angle-right"></i> </li>
			<li> <a href="javascript:void(0);"> Content Mangement / Why Equalitix  </a> </li>
		</ul>
	...
	<div class="col-md-12"> 
		...
		<div class="tabbable tabbable-custom tabbable-full-width">
			<ul class="nav nav-tabs">
				<li class="active"> <a href="#tab_1_1" data-toggle="tab">Why Equalitix</a> </li>
			</ul>
						...
						<div class="col-md-9" style="width:100%">
							<div class="row">  </div>
								...
								<div class="form-group">
									...
									<div class="col-md-8" style="width:87%">
										<textarea class="form-control" rows = "6" name="page_content" id="page_content" ><?php echo stripslashes($resultset['page_content']);?></textarea>
								...
								<div class="form-group">
									...
									<div class="col-md-8">
										...
										<a href="<?php echo base_url();?>content/who_are_we"  class="btn theme-btn grey pull-left margd">Cancel</a>
									</div>
								</div>
							</form>
						</div>
