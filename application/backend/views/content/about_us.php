...
<div class="row">
	<div class="col-md-12"> 
		...
		<ul class="page-breadcrumb breadcrumb">
			...
			<li> <a href="javascript:void(0);"> Content Mangement / About Us  </a> </li>
		</ul>
	...
	<div class="col-md-12"> 
		...
		<div class="tabbable tabbable-custom tabbable-full-width">
			<ul class="nav nav-tabs">
				<li class="active"> <a href="#tab_1_1" data-toggle="tab"> About Us </a> </li>
			</ul>
							...
							<div class="row">  </div>
								...
								<div class="form-group">
									...
									<div class="col-md-8" style="width:87%">
										...
										<span class="help-block" id="page_content_error"> </span> 
									</div>
								</div>
								<!--div class="form-group">
									<label class="control-label col-md-4" style="width:13%">After Team Content  </label>
									<div class="col-md-8" style="width:87%">
										<textarea class="form-control ckeditor" rows = "6" name="summary" id="summary" ><?php echo stripslashes($resultset['summary']);?></textarea>
										<span class="help-block" id="summary_error"> </span> 
									</div>
								</div-->
								<div class="form-group">
									...
									<div class="col-md-8">
										...
										<a href="<?php echo base_url();?>content/about_us"  class="btn theme-btn grey pull-left margd">Cancel</a>
									</div>
								</div>
							</form>
						</div>
