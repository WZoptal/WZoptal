...
<div class="row">
  <div class="col-md-12"> 
    ...
    <h3 class="page-title"> Footer Content </h3>
    <ul class="page-breadcrumb breadcrumb">
      <li> <i class="fa fa-home"></i> <a href="<?php echo base_url();?>"> Home </a> <i class="fa fa-angle-right"></i> </li>
      <li> <a href="javascript:void(0);"> Content Mangement / Footer Content </a> </li>
    </ul>
  ...
  <div class="col-md-12"> 
    ...
    <div class="tabbable tabbable-custom tabbable-full-width">
      <ul class="nav nav-tabs">
        <li class="active"> <a href="#tab_1_1" data-toggle="tab"> Footer Content </a> </li>
      </ul>
            ...
            <div class="col-md-9" style="width:100%">
              ...
              <form name="frm" id="frm" action="<?php echo base_url(); ?>content/update_page_to_database" method="post" enctype="multipart/form-data">
                ...
                <div class="form-group flare">
                  <label class="control-label col-md-4" style="width:11.333333%"> Footer Text </label>
                  <div class="col-md-8" style="width:87.666667%">
                  	<textarea class="form-control" name="page_content" style="width:500px; height:70px" id="description"><?php echo $resultset['page_content']; ?></textarea>
                    <br />
                ...
                <div class="form-group">
                  ...
                  <div class="col-md-8">
                    ...
                    <a href="<?php echo base_url();?>content/footer_content"  class="btn theme-btn grey pull-left margd">Cancel</a> </div>
                </div>
              </form>
            </div>
          </div>
...
function validate_form(){
 	...
 	if(description == ""){
 		$('.help-block').html('');
 		$('#description_error').html('Error : Please Provide Footer Text').css({'color':'red'});
 		$('#description').focus(); 
 		return false;
 	 } 
  	 else{
...
//for text length
  $('#description').keyup(function() {
	 var len = this.value.length;
	   if (len >= 210) {
			this.value = this.value.substring(0, 210);
	   }
	   $('#charLeft').text(210 - len);
  });
  $('#charLeft').text(210);
