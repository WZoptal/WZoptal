...
<div class="row">
	<div class="col-md-12"> 
		...
		<ul class="page-breadcrumb breadcrumb">
			...
			<li> <a href="javascript:void(0);"> Content Mangement / Privacy Policy  </a> </li>
		</ul>
	...
	<div class="col-md-12"> 
		...
		<div class="tabbable tabbable-custom tabbable-full-width">
			<ul class="nav nav-tabs">
				<li class="active"> <a href="#tab_1_1" data-toggle="tab"> Privacy Policy </a> </li>
			</ul>
					...
					<div class="row">
						<div class="col-md-9" style="width:100%">
							<div class="row">  </div>
								...
								<form name="frm" id="frm" action="<?php echo base_url(); ?>content/update_policy_information" method="post" enctype="multipart/form-data">
								<?php if($do=="edit"){ ?>
								...
								<div class="form-group">
									...
									<div class="col-md-8">
										...
										<a href="<?php echo base_url();?>content/privacy_policy"  class="btn theme-btn grey pull-left margd">Cancel</a>
									</div>
								</div>
							</form>
						</div>
