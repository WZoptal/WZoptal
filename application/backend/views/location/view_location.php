            ...
            <div class="col-md-12">
              ...
              <div class="tab-pane active" id="tab1">
                ...
                <div class="form-group detra">
                  ...
                  <div class="col-md-8"> <span class="detail_for_name"><?php echo !empty($resultset['address']) ? $resultset['address']: ""; ?></span> </div>
                </div>
                <div class="form-group detra">
                  <label class="control-label col-md-4">Pin Code</label>
                  <div class="col-md-8"> <span class="detail_for_name"><?php echo !empty($resultset['pincode']) ? $resultset['pincode']: ""; ?></span> </div>
                </div>
                <div class="form-group detra">
                  <label class="control-label col-md-4">Direction</label>
                  <div class="col-md-8"> <span class="detail_for_name"><?php echo !empty($resultset['direction']) ? $resultset['direction']: ""; ?></span> </div>
                </div>
                <div class="form-group detra">
                  <label class="control-label col-md-4">Latitude</label>
                  <div class="col-md-8"> <span class="detail_for_name"><?php echo !empty($resultset['latitude']) ? $resultset['latitude']: ""; ?></span> </div>
                </div>
                <div class="form-group detra">
                  <label class="control-label col-md-4">Longitude</label>
                  <div class="col-md-8"> <span class="detail_for_name"><?php echo !empty($resultset['longitude']) ? $resultset['longitude']: ""; ?></span> </div>
                </div>
                 <div class="form-group detra">
                  <label class="control-label col-md-4">Access of difficulty</label>
                  <div class="col-md-8"> <span class="detail_for_name"><?php echo !empty($resultset['access_difficulty']) ? $resultset['access_difficulty']: ""; ?></span> </div>
                </div>
                <div class="form-group detra">
                ...
                <!-- <div class="form-group detra">
                  ...
                  <div class="col-md-8"> <span class="detail_for_name">
                   <img src="<?php echo !empty($resultset['image']) ? base_url().'../pics/location/'.$resultset['image']: ""; ?>">
                 ...
                 <div class="form-group detra">
                  ...
                  <div class="col-md-8"> <span class="detail_for_name">
                    <?php foreach (array_filter(explode(",",$resultset['image'])) as $key => $value) { ?>
                         <img src="<?php echo !empty($resultset['image']) ? base_url().'../pics/location/'.$value: ""; ?>">
                   <?php  }   ?>
                    </span> </div>
                </div>
                ...
                <!-- <div class="form-group detra">
                  ...
                  <div class="col-md-8"> <span class="detail_for_name">
                     <audio controls>
                        ...
                        <source src="<?php echo !empty($resultset['audio']) ? base_url().'../pics/location/'.$resultset['audio']: ""; ?>" type="audio/mpeg">
                ...
                <div class="form-group detra">
                  ...
                  <div class="col-md-8"> <span class="detail_for_name">
                     ...
                     <?php foreach (array_filter(explode(",",$resultset['audio'])) as $key => $value) { ?>
                       ...
                       <audio controls>
                        <source src="horse.ogg" type="audio/ogg">
                        <source src="<?php echo !empty($resultset['audio']) ? base_url().'../pics/location/'.$value: ""; ?>" type="audio/mpeg">
                      Your browser does not support the audio element.
                      </audio>
                ...
                <!--  <div class="form-group detra">
                  ...
                  <div class="col-md-8"> <span class="detail_for_name">
                    <video width="320" height="240" controls>
                      <source src="<?php echo !empty($resultset['video']) ? base_url().'../pics/location/'.$resultset['video']: ""; ?>" type="video/mp4">
                ...
                <div class="form-group detra">
                  ...
                  <div class="col-md-8"> <span class="detail_for_name">
                     ...
                     <?php foreach (array_filter(explode(",",$resultset['video'])) as $key => $value) { ?>
                      <video width="320" height="240" controls>
                        <source src="<?php echo !empty($resultset['video']) ? base_url().'../pics/location/'.$value: ""; ?>" type="video/mp4">
                        <source src="movie.ogg" type="video/ogg">
                      Your browser does not support the video tag.
                      </video>
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-8"> <a href="<?php echo base_url();?>location"  class="btn theme-btn green pull-left">Back</a> </div>
                  </div>
                </div>
               </div>
            </div>
