...
<div class="row">
    <div class="col-md-12">
        ...
        <ul class="page-breadcrumb breadcrumb">
            ...
            <li><a href="javascript:void(0);">Add User</a>
            </li>
        </ul>
    </div>
</div>
    ...
    <div class="col-md-12">
        <div class="tabbable tabbable-custom tabbable-full-width">
            <ul class="nav nav-tabs">
                <li class="active"><a href="#tab_1_1" data-toggle="tab">Add User</a>
                </li>
            </ul>
                    ...
                    <div class="row">
                        <div class="col-md-9">
                            ...
                            <div class="tab-pane active" id="tab1">
                                ...
                                <form id="add_user_form" action="<?= base_url();?>users/add_user_to_database" method="post">
                                    ...
                                    <div class="row form-group">
                                        ...
                                        <div class="col-md-8">
                                            <textarea class="form-control" id="about_user" name="about_user" required></textarea>
                                        </div>
                                    </div>
                                    <div class="row form-group">
