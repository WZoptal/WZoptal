   ...
   <div class="col-md-12">
      <div class="tabbable tabbable-custom tabbable-full-width">
         <ul class="nav nav-tabs">
            <li class="active"> <a href="#tab_1_1" data-toggle="tab"> View <?=$item?> Profile </a> </li>
         </ul>
                  ...
                  <div class="col-md-12">
                     ...
                     <div class="tab-pane active" id="tab1">
                         <div class="form-group detra">
                           ...
                           <div class="col-md-8"> <span class="detail_for_name"><?= ucfirst($userdataa['username']); ?></span> </div>
                        </div>
                         <div class="form-group detra">
                           <label class="control-label col-md-4">Email</label>
                           <div class="col-md-8"> <span class="detail_for_name"><?= $userdataa['email']; ?></span> </div>
                        </div> 
						<div class="form-group detra">
                           <label class="control-label col-md-4">Location</label>
                           <div class="col-md-8"><span class="detail_for_name"><?= $userdataa['location']; ?></span> </div>
                        </div>
                        <div class="form-group detra">
                           <label class="control-label col-md-4">Contact Number</label>
                           <div class="col-md-8"> <span class="detail_for_name"><?= $userdataa['phone']; ?></span> </div>
                        </div>
                        <div class="form-group detra">
                           <label class="control-label col-md-4">Profile Picture </label>
                           <?php if($userdataa['profile_pic'] <> ''){
                               $profile_pic = BASEURL."/pics/profile_pics/".$userdataa['profile_pic'];
                           }
                           else{
                         ...
                         <div class="form-group detra">
                          ...
                          <div class="col-md-8"> <span class="detail_for_name"><?php echo date('d/m/Y',  $userdataa['time']); ?></span> </div>
                        </div>
                        <div class="form-group detra">
                          <label class="control-label col-md-4">Last Login Date </label>
                          <div class="col-md-8"> <span class="detail_for_name"><?php if($userdataa['last_login'] <> 0){ echo date('d/m/Y',  $userdataa['last_login']); } else{ ?> - <?php } ?></span> </div>
                        </div>
                         <div class="form-group detra">
                          <label class="control-label col-md-4">Status </label>
                          <div class="col-md-8"> <span class="detail_for_name">
                            <?php if($userdataa['status'] == 0){ ?> Disable <?php } else if($userdataa['status'] == 1){ ?> Enable <?php } else if($userdataa['status'] == 2){ ?> Blocked <?php } ?></span> </div>
                        </div>
                        <div class="form-group">
                           <label class="control-label col-md-4">&nbsp; </label>
                           <div class="col-md-8"> <a href="<?php echo base_url();?>users/<?=$landing?>"  class="btn theme-btn green pull-left">Back</a> </div>
                        </div>
                     </div>
                  </div>
               </div>
