      ...
      <div class="tab-content"> 
        ...
        <div id="tab_1_5" >
          <div class="row search-form-default">
            ...
            <div class="col-md-12">
              <form class="form-inline" action="<?php echo base_url();?>users/manage_artist?" id="search">
                <div class="input-group">
                  <div class="input-cont">
                    <input type="text" title="Search by UserName/Email" placeholder="Search by UserName/Email" class="form-control"  name="search"  value="<?php echo ($search!='' && $search!='search' )?$search:''; ?>"/>
                  </div>
                ...
                <tr>
                  ...
                  <td><?php if($val['status'] == '1'){ ?>
                    <span class="label label-sm "> 
                    	<a href="<?php echo base_url();?>users/enable_disable_artist/<?php echo $val['id'];?>/2/<?php echo $page; ?>" onclick="return dis_fun('<?php echo $item; ?>');"><i class="fa fa-check fonta" aria-hidden="true" style="color:#090"></i></a> </span>
                    <?php }
					else{ ?>
                    <span class="label label-sm"> <a href="<?php echo base_url();?>users/enable_disable_artist/<?php echo $val['id'];?>/1/<?php echo $page; ?>" onclick="return enb_fun('<?php echo $item; ?>');"><i class="fa fa-times fonta" aria-hidden="true" style="color:red"></i></a> </span>
                    <?php } ?></td>  
                   <td>
                   		<a class="javascript:void(0)" href="<?php echo base_url(); ?>users/view_artist/<?php echo $val['id'];?>"> <i class="fa fa-search fonta"></i> </a> 
                        <a class="javascript:void(0)" href="<?php echo base_url();?>users/archive_artist/<?php echo $val['id'];?>" onclick="return archive_fun('<?php echo $item; ?>');"><i class="fa fa-trash fonta"></i></a>
