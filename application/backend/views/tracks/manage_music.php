      ...
      <div class="tab-content"> 
        ...
        <div id="tab_1_5" >
          <div class="row search-form-default">
            ...
            <div class="col-md-12">
              <form class="form-inline" action="<?php echo base_url();?>tracks/manage_music?" id="search">
            ...
            <table class="table table-striped table-bordered table-advance table-hover">
              ...
              <tbody> 
                ...
                <tr>
				  ...
				  <?php $user_data=$this->tracks_model->get_user_data($val['user_id']); ?>
                  <td><?php echo $user_data['username']; ?></td>
                  <td><?php echo $val['file_type']==1 ? 'recorded' : "--"; ?></td>
                  <td><?php echo $val['trackname'];?></td>
                  <td><?php $generdata=$this->tracks_model->get_gener_name($val['genre']); echo $generdata['genre'];?></td>
                  <td><?php echo $val['tags'];?></td>
  				  <td><?php echo date('d/m/Y',  $val['time']); ?></td>
                  <td><?php if($val['status'] == '1'){ ?>
                    <span class="label label-sm "> 
                    	<a href="<?php echo base_url();?>tracks/enable_disable_rack/<?php echo $val['id'];?>/2/<?php echo $page; ?>" onclick="return dis_fun('<?php echo $item; ?>');"><i class="fa fa-check fonta" aria-hidden="true" style="color:#090"></i></a> </span>
                    <?php }
					else{ ?>
                    <span class="label label-sm"> <a href="<?php echo base_url();?>tracks/enable_disable_rack/<?php echo $val['id'];?>/1/<?php echo $page; ?>" onclick="return enb_fun('<?php echo $item; ?>');"><i class="fa fa-times fonta" aria-hidden="true" style="color:red"></i></a> </span>
                    <?php } ?></td>  
                   <td>
                   		<a class="javascript:void(0)" href="<?php echo base_url(); ?>tracks/view_tracks/<?php echo $val['id'];?>"> <i class="fa fa-search fonta"></i> </a> 
                        <a class="javascript:void(0)" href="<?php echo base_url();?>tracks/archive_track/<?php echo $val['id'];?>" onclick="return archive_fun('<?php echo $item; ?>');"><i class="fa fa-trash fonta"></i></a>
