 ...
 <div class="row">
  <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
    <div class="dashboard-stat yellow	">
      ...
      <div class="details">
        ...
        <div class="desc"> User Count </div>
      </div>   
      <a class="more" href="<?php echo base_url(); ?>users/manage_user"> View more <i class="m-icon-swapright m-icon-white"></i> </a>
    ...
    <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
      <div class="dashboard-stat green ">
        <div class="visual"><i class="fa fa-television" aria-hidden="true"></i> </div>
        <div class="details">
          <div class="number">
            <?=$total['episodes']?>
          </div>
          <div class="desc"> Episodes Count </div>
        </div>   
        <a class="more" href="<?php echo base_url(); ?>episode"> View more <i class="m-icon-swapright m-icon-white"></i> </a>
    ...
    <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
      <div class="dashboard-stat purple ">
        <div class="visual"><i class="fa fa-map-marker" aria-hidden="true"></i> </div>
        <div class="details">
          <div class="number">
            <?=$total['locations']?>
          </div>
          <div class="desc"> Locations Count </div>
        </div>   
        <a class="more" href="<?php echo base_url(); ?>location"> View more <i class="m-icon-swapright m-icon-white"></i> </a>
  ...
  <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
      <div class="dashboard-stat blue ">
        <div class="visual"><i class="fa fa-rocket" aria-hidden="true"></i> </div>
        <div class="details">
          <div class="number">
            <?=$total['subscription']?>
          </div>
          <div class="desc"> Subscription Count </div>
        </div>   
        <a class="more" href="<?php echo base_url(); ?>subscription"> View more <i class="m-icon-swapright m-icon-white"></i> </a>
